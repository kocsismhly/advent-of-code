...
[//]: # (| [Day 10]&#40;https://adventofcode.com/2025/day/10&#41; |   ⭐️   |   ⭐️   | [📓]&#40;./2025/DAY-10.ipynb&#41; |)
...
All solutions are written in **Python** using **Jupyter notebooks** for an interactive solving experience.

## 💡 Philosophy

This repository is all about:
- 🎯 **Problem Solving**: Enjoying the puzzle-solving process
- 🧹 **Clean Code**: Writing readable and maintainable solutions
- 📚 **Learning**: Exploring different approaches
- 🎨 **Jupyter Notebooks**: Interactive development and visualization

## 🎅 About Advent of Code

[Advent of Code](https://adventofcode.com/) is an annual coding event created by [Eric Wastl](http://was.tl/).

## 🔗 Links

- [My GitHub Profile](https://github.com/kocsismhly)
